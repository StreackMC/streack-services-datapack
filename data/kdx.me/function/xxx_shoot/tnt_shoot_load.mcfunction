...
execute as @s[scores={kdx.me.projectiles_loading=22..}] run item modify entity @s weapon.mainhand {function:"minecraft:set_components",components:{"minecraft:charged_projectiles":[{"id":"minecraft:tnt"}]}}
execute as @s[scores={kdx.me.projectiles_loading=22..}] run scoreboard players reset @s kdx.me.projectiles_loading
advancement revoke @s only kdx.me:xxx_shoot/tnt_shoot_trigger