...
execute as @s[scores={kdx.me.projectiles_loading=22..}] run item modify entity @s weapon.mainhand {function:"minecraft:set_components",components:{"minecraft:charged_projectiles":[{"id":"minecraft:fire_charge",components:{custom_data:{"streack":"enchantment_large_fireball_loaded"}}}]}}
